...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/users/create', [UserController::class, 'create'])->name('users.create')->middleware(CheckIfIsAdmin::class)->prefix('admin');
    ...
    Route::get('/users/{userId}/edit', [UserController::class, 'edit'])->name('users.edit')->middleware(CheckIfIsAdmin::class)->prefix('admin');
